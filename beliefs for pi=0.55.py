...
def compute_beliefs(pi):
    ...
    for alpha in alphas: 
        ...
        print(f'beliefs for pi = {pi}, alpha = {alpha:.4f}: p_0={beliefs[alpha][0]:.4f}, p_1_min={beliefs[alpha][1][0]:.4f}, range={beliefs[alpha][1][1]-beliefs[alpha][1][0]:.4f}')
    return beliefs

compute_beliefs(0.55)
